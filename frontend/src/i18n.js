...
const messages = {
  en: {
    message: {
      ...
      presetLabel: "Built-in Preset",
      presetNone: "None",
      presetSmallUnderlined: "Small with underlines (Yunyan)",
      presetApplied: "Preset applied",
      presetUnavailable: "The preset font is unavailable",
      presetBackgroundImageActive: "Remove the background image before applying this preset",
  ...
  cn: {
    message: {
      ...
      presetLabel: "内置预设",
      presetNone: "无",
      presetSmallUnderlined: "小字加下划线（云烟体）",
      presetApplied: "已应用预设",
      presetUnavailable: "预设字体暂不可用",
      presetBackgroundImageActive: "请先移除背景图片再应用此预设",
      resetSettings: "重置设置",
